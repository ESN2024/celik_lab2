// celik_lab2_sys_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module celik_lab2_sys_mm_interconnect_0 (
		input  wire        clk_0_clk_clk,                                  //                                clk_0_clk.clk
		input  wire        nios2_gen2_0_reset_reset_bridge_in_reset_reset, // nios2_gen2_0_reset_reset_bridge_in_reset.reset
		input  wire        RAM0_reset1_reset_bridge_in_reset_reset,        //        RAM0_reset1_reset_bridge_in_reset.reset
	...
	wire   [6:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> RAM0_s1_agent:cp_channel
	...
	wire   [6:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> SEG1_s1_agent:cp_channel
	...
	wire   [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> SEG2_s1_agent:cp_channel
	...
	wire   [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> SEG3_s1_agent:cp_channel
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                           //                      clk.clk
		.reset                  (RAM0_reset1_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                            //             clk.clk
		.reset                   (RAM0_reset1_reset_bridge_in_reset_reset),  //       clk_reset.reset
	...
	celik_lab2_sys_mm_interconnect_0_router router (
	...
	celik_lab2_sys_mm_interconnect_0_router_001 router_001 (
	...
	celik_lab2_sys_mm_interconnect_0_router_002 router_002 (
	...
	celik_lab2_sys_mm_interconnect_0_router_003 router_003 (
	...
	celik_lab2_sys_mm_interconnect_0_router_003 router_004 (
	...
	celik_lab2_sys_mm_interconnect_0_router_002 router_005 (
	...
	celik_lab2_sys_mm_interconnect_0_router_002 router_006 (
	...
	celik_lab2_sys_mm_interconnect_0_router_002 router_007 (
	...
	celik_lab2_sys_mm_interconnect_0_router_002 router_008 (
	...
	celik_lab2_sys_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	celik_lab2_sys_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	celik_lab2_sys_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	celik_lab2_sys_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	celik_lab2_sys_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (RAM0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	celik_lab2_sys_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	celik_lab2_sys_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	celik_lab2_sys_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	celik_lab2_sys_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	celik_lab2_sys_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	celik_lab2_sys_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	celik_lab2_sys_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (RAM0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	celik_lab2_sys_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	celik_lab2_sys_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	celik_lab2_sys_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	celik_lab2_sys_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	celik_lab2_sys_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	celik_lab2_sys_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	celik_lab2_sys_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	celik_lab2_sys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                           // in_clk_0.clk
		.in_rst_0_reset (RAM0_reset1_reset_bridge_in_reset_reset), // in_rst_0.reset
